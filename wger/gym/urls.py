...
patterns_gym = [
    ...
    url(
        r"^user/(?P<user_pk>\d+)/permission-edit$",
        gym.gym_permissions_user_edit,
        name="edit-user-permission",
    ),
    url(
        r"^user/(?P<user_pk>\d+)/reset-user-password$",
...
patterns_admin_notes = [
    url(
        r"^list/user/(?P<user_pk>\d+)$",
        admin_notes.ListView.as_view(),
        name="list",
    ),
    url(
        r"^add/user/(?P<user_pk>\d+)$",
...
patterns_documents = [
    ...
    url(
        r"^add/user/(?P<user_pk>\d+)$", document.AddView.as_view(), name="add"
    ),
...
patterns_contract_types = [
    ...
    url(
        r"^edit/(?P<pk>\d+)$", contract_type.UpdateView.as_view(), name="edit"
    ),
    url(
        r"^delete/(?P<pk>\d+)$",
...
patterns_contract_options = [
    url(
        r"^add/(?P<gym_pk>\d+)$", contract_option.AddView.as_view(), name="add"
    ),
    url(
        r"^edit/(?P<pk>\d+)$",
...
patterns_export = [url(r"^users/(?P<gym_pk>\d+)$", export.users, name="users")]
...
urlpatterns = [
    ...
    url(
        r"^user-config/", include(patterns_userconfig, namespace="user_config")
    ),
