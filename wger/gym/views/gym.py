...
class GymUserListView(
    LoginRequiredMixin, WgerMultiplePermissionRequiredMixin, ListView
):
    """
    ...
    def get_queryset(self):
        ...
        for u in Gym.objects.get_members(self.kwargs["pk"]).select_related(
            "usercache"
        ):
            out["members"].append(
...
class GymAddView(
    WgerFormMixin, LoginRequiredMixin, PermissionRequiredMixin, CreateView
):
    """
