...
class IngredientEditView(
    IngredientMixin, LoginRequiredMixin, PermissionRequiredMixin, UpdateView
):
    """
...
def accept(request, pk):
    ...
    messages.success(
        request, _("Ingredient was successfully added to the general database")
    )
...
def decline(request, pk):
    ...
    ingredient.save()
    messages.success(
        request, _("Ingredient was successfully marked as rejected")
    )
    return HttpResponseRedirect(ingredient.get_absolute_url())
