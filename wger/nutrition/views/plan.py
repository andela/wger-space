    ...
    * http://www.reportlab.com/apis/reportlab/dev/platypus.html
    ...
    for meal in plan.meal_set.select_related():
        ...
        if not meal.time:
            p = Paragraph(
                u'<para align="center"> \
                    <strong>{nr} {meal_nr}</strong></para>'.format(
                    nr=_("Nr."), meal_nr=i
                ),
                styleSheet["Normal"],
            )
        ...
        for item in meal.mealitem_set.select_related():
            ...
            data.append(
                [
                    Paragraph(
                        u"{0}{1}".format(item.amount, unit_name),
                        styleSheet["Normal"],
                    ),
                    p,
                ]
    ...
    data.append(
        [
            Paragraph(
                u'<para align="center">{0}</para>'.format(
                    _("Nutritional data")
                ),
                styleSheet["Bold"],
            )
    ...
    data.append(
        [
            ...
            Paragraph(
                six.text_type(plan_data["total"]["energy"]),
                styleSheet["Normal"],
            ),
        ]
    )
    ...
    data.append(
        [
            ...
            Paragraph(
                six.text_type(plan_data["percent"]["fat"]),
                styleSheet["Normal"],
            ),
            Paragraph(
    ...
    data.append(
        [
            Paragraph(
                _("Saturated fat content in fats"), styleSheet["Normal"]
            ),
            Paragraph(
    ...
    data.append(
        [
            ...
            Paragraph(
                six.text_type(plan_data["total"]["fibres"]),
                styleSheet["Normal"],
            ),
        ]
    )
    data.append(
        [
            ...
            Paragraph(
                six.text_type(plan_data["total"]["sodium"]),
                styleSheet["Normal"],
            ),
        ]
    )
