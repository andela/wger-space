    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.IntegerField(verbose_name="Order", blank=True),
                ),
                (
                    "comment",
                    models.CharField(
                ...
                (
                    "set",
                    models.ForeignKey(verbose_name="Sets", to="manager.Set"),
                ),
            ],
        ...
        migrations.AlterUniqueTogether(
            name="workoutsession", unique_together=set([("date", "user")])
        ),
        migrations.AddField(
