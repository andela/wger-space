...
def render_workout_day(
    day, nr_of_weeks=7, images=False, comments=False, only_table=False
):
    """
    ...
    for set in day["set_list"]:
        ...
        for exercise in set["exercise_list"]:
            ...
            data.append(
                [set_count, exercise_content, setting_out] + [""] * nr_of_weeks
            )
        set_count += 1
    ...
    # The rows with exercises range from exercise_start till the end of
    # the data
    # list
