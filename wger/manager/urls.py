...
patterns_log = [
    ...
    url(
        r"^(?P<pk>\d+)/edit$", log.WorkoutLogUpdateView.as_view(), name="edit"
    ),  # JS
    url(
        r"^(?P<pk>\d+)/delete$",
...
patterns_workout = [
    ...
    url(
        r"^(?P<pk>\d+)/edit/$", workout.WorkoutEditView.as_view(), name="edit"
    ),
    url(
        r"^(?P<pk>\d+)/delete/$",
    ...
    url(
        r"^(?P<pk>\d+)/ical/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})$",
        ical.export,
        name="ical",
    ),
    ...
    url(
        r"^(?P<id>\d+)/pdf/log/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})$",
        pdf.workout_log,
        name="pdf-log",
    ),
    url(
    ...
    url(
        r"^(?P<id>\d+)/pdf/table/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})$",
        pdf.workout_view,
        name="pdf-table",
    ),
    url(
...
patterns_schedule = [
    ...
    url(
        r"^(?P<pk>\d+)/pdf/log/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})$",
        schedule.export_pdf_log,
        name="pdf-log",
    ),
    url(
    ...
    url(
        r"^(?P<pk>\d+)/pdf/table/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})$",
        schedule.export_pdf_table,
        name="pdf-table",
    ),
    url(
    ...
    url(
        r"^(?P<pk>\d+)/pdf/table$", schedule.export_pdf_table, name="pdf-table"
    ),
]
