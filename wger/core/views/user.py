...
class UserDeactivateView(
    LoginRequiredMixin, WgerMultiplePermissionRequiredMixin, RedirectView
):
    """
    Deactivates a user
    """
    ...
    def get_redirect_url(self, pk):
        ...
        edit_user.save()
        messages.success(
            self.request, _("The user was successfully deactivated")
        )
...
class UserActivateView(
    ...
    def get_redirect_url(self, pk):
        ...
        edit_user.save()
        messages.success(
            self.request, _("The user was successfully activated")
        )
        return reverse("core:user:overview", kwargs=({"pk": pk}))
