...
class ExerciseCorrectView(
    ExercisesEditAddView, LoginRequiredMixin, UpdateView
):
    """
    Generic view to update an existing exercise
    """
    ...
    messages = _(
        "Thank you. Once the changes are reviewed the exercise will be \
         updated."
    )
...
def decline(request, pk):
    ...
    exercise.save()
    messages.success(
        request, _("Exercise was successfully marked as rejected")
    )
    return HttpResponseRedirect(exercise.get_absolute_url())
