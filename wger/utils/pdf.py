...
def load_ingredient_languages(request):
    ...
    wishes o also see the ingredients in English (from the US Department
    of Agriculture),
    show those too.
...
styleSheet.add(
    ParagraphStyle(name="Normal", fontName="OpenSans", fontSize=10, leading=12)
)
styleSheet.add(
    ParagraphStyle(parent=styleSheet["Normal"], fontSize=8, name="Small")
)
styleSheet.add(
    ParagraphStyle(
...
styleSheet.add(
    ParagraphStyle(
        parent=styleSheet["Normal"], name="Bold", fontName="OpenSans-Bold"
    )
)
