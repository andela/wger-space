...
class AmazonUserAgentTestCase(WorkoutManagerTestCase):
    ...
    def test_user_agent_3rd_generation(self):
        ...
        agent = (
            "Mozilla/5.0 (Linux; Android 4.2.2; <device> Build/<build>) \
                AppleWebKit/ "
    ...
    def test_user_agent_2nd_generation(self):
        ...
        agent = (
            "Mozilla/5.0 (Linux; Android 4.0.3; <device> Build/<build>) \
            AppleWebKit/<webkit>"
    ...
    def test_user_agent_1st_generation(self):
        ...
        agent = (
            "Mozilla/5.0 (Linux; U; Android 2.3.4; <locale>; \
    ...
    def test_user_agent_generic_android(self):
        ...
        agent = (
            "Mozilla/5.0 (Linux; U; Android <version>; <locale>; Build/<build>) \
                AppleWebKit/"
